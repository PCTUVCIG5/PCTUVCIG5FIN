...
<table class="table" id="amenagements-table">
        ...
        @foreach($amenagements as $amenagement)
            <tr>
                ...
                <td> -->
                <a href="{{ url('change-status-amenagement/'.$amenagement->id) }}" onclick="return confirm('Etre vous sûr que {{ $amenagement->habitant->nomHabi }} {{ $amenagement->habitant->prenHabi }} reamenage ?')" class="btn btn-sm btn-success">Demenage</a>
